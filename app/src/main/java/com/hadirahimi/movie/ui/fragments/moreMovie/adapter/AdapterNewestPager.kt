...
class AdapterNewestPager @Inject constructor(@ApplicationContext val context : Context) :
    PagingDataAdapter<Result , AdapterNewestPager.MyViewHolder>(differCallBack)
{
...
//       }
//       class NewestMovie(private val oldItem : List<Result> , private val newItem:List<Result>):DiffUtil.Callback()
//       {
